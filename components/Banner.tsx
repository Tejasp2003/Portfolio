...
const Banner = () => {
  ...
  return (
    ...
    >
      ...
      >
        I am a final year Computer Engineering student. I am currently focused on
        being proficient in both frontend and backend development. I am looking
        for job oppurtunities as a 
        <span className="text-textGreen font-bold"> Software Engineer | Full stack developer.</span>.
        <a
          href="#"
